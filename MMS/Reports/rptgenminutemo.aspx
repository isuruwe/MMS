<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptgenminutemo.aspx.cs" Inherits="MMS.Reports.rptgenminutemo" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="659px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="806px">
            <LocalReport ReportPath="Reports\rdlcsurgery.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
