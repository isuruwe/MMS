<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptclaimtsir.aspx.cs" Inherits="MMS.Reports.rptclaimtsir" %>
    ...
    <div>
     ...
     <div class="col-md-6">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="632px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1002px">
            <LocalReport ReportPath="Reports\rdlcclaintsir.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
